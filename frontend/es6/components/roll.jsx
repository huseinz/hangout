...
class Roll extends React.Component{
    ...
    upd_lb = (e) => {this.setState({lb:parseInt(e.target.value)})};
    upd_ub = (e) => {this.setState({ub:parseInt(e.target.value)})};

    render(){
        return(
            <div className="cntr randominteger">
                <input value={this.state.lb} onChange={this.upd_lb} type="number" size="7" className="form-control rn_lb" /> to
